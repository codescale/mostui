...
function getMongoStat(requestId, url, callback) {
    serverStatus(url, function (mongoStat) {
        ...
        // page faults
        mongoStatDTO.pageFaults = mongoStat.extra_info.page_faults - mongoStatLatestRaw[requestId].extra_info.page_faults;
